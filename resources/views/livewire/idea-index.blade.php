<div
    ...
    "
    class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl
                flex cursor-pointer"
>
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        ...
        <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                >
                    <div class="{{ 'status-'.Str::kebab($idea->status->name) }} bg-gray-400 text-[10px] font-bold uppercase leading-none rounded-full
                                text-center w-32 h-7 py-2 px-4">{{ $idea->status->name }}</div>
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @else
                        <button
                            ...
                            rounded-xl hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5"
                        >
                            Vote
                        </button>
                    @endif
