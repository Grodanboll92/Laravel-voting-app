<div>
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/3">
            <select wire:model="filter" name="other_filters" id="other_filters" class="w-full rounded-xl
    ...
    <div class="ideas-container space-y-6 my-8">
        ...
        @empty
            <div class="mx-auto w-70 mt-12">
                <img src="{{ asset('img/no-ideas.svg') }}" alt="No Ideas" class="mx-auto mix"
                     style="mix-blend-mode: luminosity">
                <div class="text-gray-400 text-center font-bold mt-7">No ideas where found...</div>
            </div>
        @endforelse
