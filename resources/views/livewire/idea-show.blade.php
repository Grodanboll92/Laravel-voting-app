            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div
                        ...
                        x-data="{ isOpen: false }"
                    >
                        <div class="{{ 'status-'.Str::kebab($idea->status->name) }} bg-gray-400 text-[10px]  font-bold
                            uppercase leading-none rounded-full text-center w-32 h-7 py-2 px-4">{{
                                ...
                                @endcan
                                    ...
                                    @endcan
                                        ...
                                        <li>
                                            ...
                                            "
                                                class="hover:bg-gray-100 block transition duration-150 ease-in
                                                px-5 py-3"
                                            >
                                                Mark as Spam
                                            </a>
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if ($hasVoted)
                        <button wire:click.prevent="vote"
                            ...
                            uppercase rounded-xl hover:blue-hover transition duration-150
                    ...
                    @else
                        <button wire:click.prevent="vote"
                            ...
                            uppercase rounded-xl hover:border-gray-400 transition duration-150
                            ease-in px-4 py-3 -mx-5"
                        >
                            Vote
                        </button>
